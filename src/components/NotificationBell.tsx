        ...
        {showDropdown && (
          <>
            ...
            <motion.div
              ...
              className="fixed md:absolute left-2 right-2 md:left-auto md:right-0 top-16 md:mt-3 w-auto md:w-96 bg-white border border-bento-border shadow-xl z-30 overflow-hidden max-h-[70vh] md:max-h-[28rem]"
            >
